...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.visp.net/';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-UBO" by default
     *
     * @var string
     */
    protected $userAgent = "UBO-SDK/1.0.0/php";
    ...
    {
        $report  = 'PHP SDK (Ubo\Client) Debug Report:' . PHP_EOL;
