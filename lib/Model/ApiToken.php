...
class ApiToken implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $uboModelName = 'ApiToken';
    ...
    protected static $uboTypes = array(
        'payload' => '\Ubo\Client\Model\ApiTokenPayload',
        'token' => 'string'
    );
    ...
    /**
     * Gets payload
     * @return \Ubo\Client\Model\ApiTokenPayload
     */
    ...
    /**
     * Sets payload
     * @param \Ubo\Client\Model\ApiTokenPayload $payload
     * @return $this
     */
